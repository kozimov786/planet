Vue.component("site-page", {
  template:
    ...
    <main class="site-main">
        ...
        <ul class="info-list container">
              <li class="info-list__item" v-for="item in infoItem">{{ planets[selectedPlanet].info[item] }}
  ...
  data() {
    return {
      ...
      planets: {
        "Mercury": {
          name: "Mercury",
          wikiLink: "https://ru.wikipedia.org/wiki/Mercury",
          bgColor: "#419Ebb",
          "overview": {
        ...
        "Venus": {
          name: "Venus",
          wikiLink: "https://ru.wikipedia.org/wiki/venus",
          bgColor: "#EDA249",
          "overview": {
        ...
        "Earth": {
          name: "Earth",
          wikiLink: "https://ru.wikipedia.org/wiki/earth",
          bgColor: "#6D2ED5",
          "overview": {
        ...
        "Mars": {
          name: "Mars",
          wikiLink: "https://ru.wikipedia.org/wiki/mars",
          bgColor: "#D14C32",
          "overview": {
        ...
        "Jupiter": {
          name: "Jupiter",
          wikiLink: "https://ru.wikipedia.org/wiki/jupiter",
          bgColor: " #D83A34",
          "overview": {
        ...
        "Saturn": {
          name: "Saturn",
          wikiLink: "https://ru.wikipedia.org/wiki/saturn",
          bgColor: " #CD5120",
          "overview": {
        ...
        "Uranus": {
          name: "Uranus",
          wikiLink: "https://ru.wikipedia.org/wiki/uranus",
          bgColor: " #1EC1A2",
          "overview": {
        ...
        "Neptune": {
          name: "Neptune",
          wikiLink: "https://ru.wikipedia.org/wiki/neptune",
          bgColor: " #2D68F0",
          "overview": {
  ...
  computed: {
    image() {
      return this.planets[this.selectedPlanet][this.selectedBtn].img
    },
    imageAlt() {
      return this.planets[this.selectedPlanet][this.selectedBtn].imgAlt
    },
    link() {
      return this.planets[this.selectedPlanet].wikiLink
    }
  },
